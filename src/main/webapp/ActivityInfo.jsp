        ...
        <div class="container-fluid">
            ...
            <div id="navbar-menu">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src=<%=client.getStuSrc()%> class="img-circle" alt="Avatar"> <span><%=client.getuName()%></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
                        <ul class="dropdown-menu">
            ...
            <div class="container-fluid">
                <div class="panel panel-headline">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="Community?getCNum=<%=cNum%>"><h3><%=activity.getcName()%></h3></a>

...
<%
    ...
    List<Community> communities = communityService.commToAudit();
%>
<!DOCTYPE html>
<html>
<head>
    <title>applicationRebiew</title>
        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li>
                        <a href="applicationReview.jsp" class="active">
                            <i class="lnr lnr-alarm"></i>
                            <span>申请审核</span></a>
                    </li>

                    <li>
                        <a href="comList.jsp" class="">
                    ...
                    <div class="panel" style="border-radius: 5px 5px 0 0;">
                        ...
                        <div class="panel-body" style="display: none;">
                            ...
                            <div style="display: inline-block  " align="left" >
                                ...
                                <a><%out.print(communities.get(i).getcNum());%></a>
                                </br>
                                ...
                                <a><%out.print(communities.get(i).getcStuNum());%></a>
                                </br>
                            </div>
